        ...
        eventList.forEach((event) => {
            ...
            eventCard.innerHTML = `
                ...
                <div>
                    ...
                    <button class="btn btn-primary" id="event-${event.eventId}">Ver Mas</button>
                </div>
            `;

            eventCard.querySelector(`#event-${event.eventId}`).addEventListener("click", () => {
                // Navegar a la pantalla de detalles del evento
                // alert("NAVEGANDO A LOS DETALLES DEL EVENTO!");
